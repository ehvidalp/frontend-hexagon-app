...
<template>
  <div
    class="relative w-32 flex flex-col items-center min-w-0 break-words bg-zinc-100 border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
    <div class="p-4 mx-6 mb-0 text-center border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
      <div
        class="w-16 h-16 text-center bg-center icon bg-gradient-to-r flex justify-center items-center from-blue-800 to-indigo-900 shadow-soft-2xl rounded-xl">
